...
See [docs/architecture.md](docs/architecture.md) for the full system design and [docs/overview.md](docs/overview.md) for feature details.
...
| `cursorSessionTracker.firebaseApiKey` | `""` | Firebase Web API key for token refresh |
